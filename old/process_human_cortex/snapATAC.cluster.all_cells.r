...
params = paste0(".Frag",frag_cutoff,".TSS",TSS_cutoff,".AllCells",".seed",seed,".dimPC",dims,".K",k,".res",res)
...
genes = read.table("../../annotations/hg38.gencode.v28.gene.bed")
genes.gr = GRanges(genes[,1],
    IRanges(genes[,2], genes[,3]), name=genes[,4]
     );

marker.genes = c("MOG","APOE","PDGFRA","C1QB","SLC17A7","GAD2","FOXD1")
...
a$stage = substr(a$sample,4,6)
a$rep = substr(a$sample,8,11)
