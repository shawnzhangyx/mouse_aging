...
for ( sample in samples) {
 print(sample)
 tmp = Read10X(data.dir = paste0("../../data/snRNA/cellranger.intron/",sample,"/outs/filtered_feature_bc_matrix/"))
 seurat.list[[sample]] = CreateSeuratObject(counts = tmp, project = "DH", min.cells = 3, min.features = 200)
}
