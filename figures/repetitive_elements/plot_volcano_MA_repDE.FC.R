library(ggplot2)
library(ggrepel)
setwd("/projects/ps-renlab/lamaral/projects/aging_RNA/FC/analysis/repeat_expression/consistent_clusters/")
...
key = read.csv("/projects/ps-renlab/lamaral/projects/aging_RNA/FC/analysis/rna_atac_cons_key.csv", header =F)
...
pdf("FC.repeat_ma_volcano_allclusters.pdf", height = 20, width = 20)
