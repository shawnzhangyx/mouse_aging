...
for (i in 1:clusters) {
  ...
  all$sig[which(H3K4me3$V5<0.01 & H3K4me3$V4<0)] = paste0("DOWN-",length(which(H3K4me3$V5<0.01 & H3K4me3$V4<0)))
  all$sig[which(H3K4me3$V5<0.01 & H3K4me3$V4>0)] = paste0("UP-",length(which(H3K4me3$V5<0.01 & H3K4me3$V4>0)))
...
pdf(paste0(tissue,".custom_ann_all_together.pdf"), height = 18, width = 20)
