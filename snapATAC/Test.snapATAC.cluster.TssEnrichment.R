...
parser$add_argument("-d", "--pc_dim",type="integer", default = 20, help="num of PCA dims used for clustering [default %(default)s]")
...
parser$add_argument("--knn_k", default=50, type="integer",help="K for KNN.")
parser$add_argument("--leiden_res", default=0.5, type="double",help="resolution parameter for leiden.")
...
marker.genes = c("Mog","Apoe","Pdgfra","C1qb","Slc17a7","Gad2","Nov","Prox1","Foxd1")
