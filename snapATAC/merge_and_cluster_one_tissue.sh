...
#  -o ../../analysis/snapATAC/HT/snapFiles/HT.pool.snapATAC
Rscript snapATAC.cluster.harmony.r \
  ../../analysis/snapATAC/HT/snapFiles/HT.pool.snapATAC.Frag500.TSS7.Landmark30k.seed1.dimPC20.K20.res0.7.cluster.RData \
  ../../analysis/snapATAC/HT/snapFiles/HT.pool.snapATAC.Frag500.TSS7.Landmark30k.seed1.dimPC20.K20.res0.7
...
#BM
Rscript snapATAC.cluster.v2.r \
  -i ../../analysis/snapATAC/BM/snapFiles/BM.pool.snapATAC.raw.RData \
  --seed 1 \
  --tss-cutoff 10 \
  --fragment-cutoff 500 \
  --landmark_num 40000 \
  --pc_dim 20 \
  -o ../../analysis/snapATAC/BM/snapFiles/BM.pool.snapATAC
Rscript snapATAC.cluster.harmony.r \
  ../../analysis/snapATAC/BM/snapFiles/BM.pool.snapATAC.Frag500.TSS10.Landmark40k.seed1.dimPC20.K20.res0.7.cluster.RData \
  ../../analysis/snapATAC/BM/snapFiles/BM.pool.snapATAC.Frag500.TSS10.Landmark40k.seed1.dimPC20.K20.res0.7
...
Rscript make_barcode_information.r \
  BM \
  BM.pool.snapATAC.Frag500.TSS10.Landmark40k.seed1.dimPC20.K20.res0.7.harmony.meta.txt
